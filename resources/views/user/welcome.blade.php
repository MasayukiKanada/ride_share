...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Font Awsome -->
        <script src="https://kit.fontawesome.com/ce4c77c7d8.js" crossorigin="anonymous"></script>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <i class="fa-solid fa-user w-12 h-12" style="color: #505050;"></i>
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('/dashboard') }}" class="underline text-gray-900 dark:text-white">利用者</a></div>
                            </div>
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                            <div class="flex items-center">
                                <i class="fa-solid fa-car w-12 h-12" style="color: #505050;"></i>
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('/driver/dashboard') }}" class="underline text-gray-900 dark:text-white">ドライバー</a></div>
                            </div>
