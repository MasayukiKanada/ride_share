                            ...
                            <table>
                                ...
                                @foreach($before_cons as $before_con)
                                            <tr class="border-b border-gray-400">
                                                ...
                                                <td class="text-center bg-indigo-600 font-semibold text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><a class="block px-2 py-2" href="{{ route('user.contracts.show', [$before_con->id]) }}">見る</a></td>
                                            </tr>
                                @endforeach
                            </table>
                        @endif
                        ...
                        <table>
                            ...
                            @foreach($after_cons as $after_con)
                                        <tr class="border-b border-gray-400">
                                            ...
                                            <td class="text-center bg-indigo-600 font-semibold text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><a class="block px-2 py-2" href="{{ route('user.contracts.show', [$after_con->id]) }}">見る</a></td>
                                        </tr>
                            @endforeach
                        @endif
                    </div>
